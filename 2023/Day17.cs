...
public static class Day17
{
    ...
    public static Dictionary<Direction, int> DirectionAxis = new() { { new(1, 0), 0 }, { new(0, 1), 1 }, { new(-1, 0), 0 }, { new(0, -1), 1 } };
    ...
    private static readonly List<List<int>>[][] Distances = new List<List<int>>[][] { new List<List<int>>[MaxDistance], new List<List<int>>[MaxDistance] };
